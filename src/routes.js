...
const Post = React.lazy(() => import('./views/post/all_post/index'));
const AddPost = React.lazy(() => import('./views/post/add/index'));
...
const routes = [
  ...
  { path: '/post/all_post', exact: true,  name: 'Post', component: Post },
  { path: '/post/add', exact: true,  name: 'AddPost', component: AddPost },
